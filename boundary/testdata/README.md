...
| `named_constant_missing` | named constantを境界値として評価する | `ShippingFee: boundary value 5000 is not tested` |
| `named_constant_complete` | named constantでも3分類が揃えば報告しない | 診断なし |
| `constant_expression` | constant expressionをcompile時に評価する | `ShippingFee: boundary value 5000 is not tested` |
| `runtime_variable` | 一般変数をconstantとして扱わない | 診断なし |
